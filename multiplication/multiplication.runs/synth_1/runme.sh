...
HD_PWD='E:/8th semester/VHDL/hw1/multiplication/multiplication.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myadder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myadder.tcl
